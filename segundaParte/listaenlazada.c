...
int main(int argc, char *argv[]) {
  ...
  dlist_ordenar_lista(lista, dlist_selection_sort, compara_por_edad, "selection_sort_edad.txt", escribir_persona);
  dlist_ordenar_lista(lista, dlist_selection_sort, compara_por_localidad, "selection_sort_loc.txt", escribir_persona);
  dlist_ordenar_lista(lista, dlist_insertion_sort, compara_por_edad, "insertion_sort_edad.txt", escribir_persona);
  dlist_ordenar_lista(lista, dlist_insertion_sort, compara_por_localidad, "insertion_sort_loc.txt", escribir_persona);
  dlist_ordenar_lista(lista, dlist_merge_sort, compara_por_edad, "merge_sort_edad.txt", escribir_persona);
  dlist_ordenar_lista(lista, dlist_merge_sort, compara_por_localidad, "merge_sort_loc.txt", escribir_persona);
